...
<link href="{{asset('assets/front/pages/css/animate.css')}}" rel="stylesheet">
<link href="{{asset('assets/front/plugins/owl.carousel/assets/owl.carousel.css')}}" rel="stylesheet">
<link href="{{asset('assets/front/plugins/cubeportfolio/cubeportfolio/css/cubeportfolio.min.css')}}" rel="stylesheet">
<!-- END PAGE LEVEL PLUGIN STYLES -->
<!-- BEGIN THEME STYLES -->
<link href="{{asset('assets/front/onepage2/css/layout.css')}}" rel="stylesheet" type="text/css"/>
<link href="{{asset('assets/front/onepage2/css/custom.css')}}" rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->
            ...
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand" href="#intro">
                        <img class="logo-default" src="{{asset('assets/front/onepage2/img/logo_default.png')}}" alt="Logo">
                        <img class="logo-scroll" src="{{asset('assets/front/onepage2/img/logo_scroll.png')}}" alt="Logo">
                    </a>
                </div>
                ...
                <div class="row">
                        ...
                        <div class="services sm-margin-bottom-100">
                            <div class="services-wrap">
                                <div class="service-body">
                                    <img src="{{asset('assets/front/onepage2/img/widgets/icon1.png')}}" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="services sm-margin-bottom-100">
                            <div class="services-wrap">
                                <div class="service-body">
                                    <img src="{{asset('assets/front/onepage2/img/widgets/icon2.png')}}" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="services">
                            <div class="services-wrap">
                                <div class="service-body">
                                    <img src="{{asset('assets/front/onepage2/img/widgets/icon3.png')}}" alt="">
                                </div>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="row margin-bottom-70">
                        <div class="col-md-6 md-margin-bottom-70">
                            <div class="features">
                                <img src="{{asset('assets/front/onepage2/img/widgets/screen1.png')}}" alt="">
                        ...
                        <div class="col-md-6">
                            <div class="features">
                                <img src="{{asset('assets/front/onepage2/img/widgets/screen2.png')}}" alt="">
                                <div class="features-in">
                    ...
                    <div class="row margin-bottom-80">
                        <div class="col-md-6 md-margin-bottom-70">
                            <div class="features">
                                <img src="{{asset('assets/front/onepage2/img/widgets/screen3.png')}}" alt="">
                                <div class="features-in">
                        ...
                        <div class="col-md-6">
                            <div class="features">
                                <img src="{{asset('assets/front/onepage2/img/widgets/screen4.png')}}" alt="">
                                <div class="features-in">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="team-members">
                                        <div class="team-avatar">
                                            <img class="img-responsive" src="{{asset('assets/front/onepage2/img/member/member1.png')}}" alt="">
                                        </div>
                                        <div class="team-desc">
                                ...
                                <div class="col-sm-4">
                                    <div class="team-members">
                                        <div class="team-avatar">
                                            <img class="img-responsive" src="{{asset('assets/front/onepage2/img/member/member2.png')}}" alt="">
                                        </div>
                                        <div class="team-desc">
                                            <div class="team-details">
                                                <h4>Melisa Doe</h4>
                                ...
                                <div class="col-sm-4">
                                    <div class="team-members">
                                        <div class="team-avatar">
                                            <img class="img-responsive" src="{{asset('assets/front/onepage2/img/member/member3.png')}}" alt="">
                                        </div>
                                        <div class="team-desc">
                                            <div class="team-details">
                                                <h4>Alex Atkinson</h4>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="team-members">
                                        <div class="team-avatar">
                                            <img class="img-responsive" src="{{asset('assets/front/onepage2/img/member/member4.png')}}" alt="">
                                        </div>
                                        <div class="team-desc">
                                            <div class="team-details">
                                                <h4>John Doe</h4>
                                ...
                                <div class="col-sm-4">
                                    <div class="team-members">
                                        <div class="team-avatar">
                                            <img class="img-responsive" src="{{asset('assets/front/onepage2/img/member/member5.png')}}" alt="">
                                        </div>
                                        <div class="team-desc">
                                            <div class="team-details">
                                                <h4>Melisa Doe</h4>
                                ...
                                <div class="col-sm-4">
                                    <div class="team-members">
                                        <div class="team-avatar">
                                            <img class="img-responsive" src="{{asset('assets/front/onepage2/img/member/member6.png')}}" alt="">
                                        </div>
                                        <div class="team-desc">
                                            <div class="team-details">
                                                <h4>Alex Atkinson</h4>
                    ...
                    <div class="container">
                        ...
                        <div class="owl-carousel">
                            <div class="item" data-quote="#client-quote-1">
                                <img src="{{asset('assets/front/onepage2/img/clients/logo1.png')}}" alt="">
                            </div>
                            <div class="item" data-quote="#client-quote-2">
                                <img src="{{asset('assets/front/onepage2/img/clients/logo2.png')}}" alt="">
                            </div>
                            <div class="item" data-quote="#client-quote-3">
                                <img src="{{asset('assets/front/onepage2/img/clients/logo3.png')}}" alt="">
                            </div>
                            <div class="item" data-quote="#client-quote-4">
                                <img src="{{asset('assets/front/onepage2/img/clients/logo4.png')}}" alt="">
                            </div>
                            <div class="item" data-quote="#client-quote-5">
                                <img src="{{asset('assets/front/onepage2/img/clients/logo5.png')}}" alt="">
                            </div>
                            <div class="item" data-quote="#client-quote-6">
                                <img src="{{asset('assets/front/onepage2/img/clients/logo6.png')}}" alt="">
                            </div>
                            <div class="item" data-quote="#client-quote-7">
                                <img src="{{asset('assets/front/onepage2/img/clients/logo7.png')}}" alt="">
                            </div>
                            <div class="item" data-quote="#client-quote-8">
                                <img src="{{asset('assets/front/onepage2/img/clients/logo8.png')}}" alt="">
                            </div>
                            <div class="item" data-quote="#client-quote-9">
                                <img src="{{asset('assets/front/onepage2/img/clients/logo9.png')}}" alt="">
                            </div>
                            <div class="item" data-quote="#client-quote-10">
                                <img src="{{asset('assets/front/onepage2/img/clients/logo10.png')}}" alt="">
                            </div>
                            <div class="item" data-quote="#client-quote-11">
                                <img src="{{asset('assets/front/onepage2/img/clients/logo11.png')}}" alt="">
                            </div>
                            <div class="item" data-quote="#client-quote-12">
                                <img src="{{asset('assets/front/onepage2/img/clients/logo12.png')}}" alt="">
                            </div>
                            <div class="item" data-quote="#client-quote-13">
                                <img src="{{asset('assets/front/onepage2/img/clients/logo13.png')}}" alt="">
                            </div>
                            <div class="item" data-quote="#client-quote-14">
                                <img src="{{asset('assets/front/onepage2/img/clients/logo14.png')}}" alt="">
                            </div>
                        </div>
                        <!-- End Owl Carousel -->
                    </div>
                            ...
                            <div class="col-md-7">
                                ...
                                <div id="grid-container" class="cbp-l-grid-agency">
                                    <div class="cbp-item ecommerce">
                                        <div class="cbp-caption">
                                            <div class="cbp-caption-hover-gradient">
                                                <img src="{{asset('assets/front/onepage2/img/portfolio/01.jpg')}}" alt="">
                                            </div>
                                            <div class="cbp-caption-activeWrap">
                                                <div class="cbp-l-caption-alignCenter">
                                                    <div class="cbp-l-caption-body portfolio-icons">
                                                        <a href="{{asset('assets/front/onepage2/img/portfolio/01.jpg')}}" class="cbp-lightbox" data-title="Title"><i class="fa fa-search"></i></a>
                                    ...
                                    <div class="cbp-item admin">
                                        <div class="cbp-caption">
                                            <div class="cbp-caption-hover-gradient">
                                                <img src="{{asset('assets/front/onepage2/img/portfolio/02.jpg')}}" alt="">
                                            </div>
                                            <div class="cbp-caption-activeWrap">
                                                <div class="cbp-l-caption-alignCenter">
                                                    <div class="cbp-l-caption-body portfolio-icons">
                                                        <a href="{{asset('assets/front/onepage2/img/portfolio/02.jpg')}}" class="cbp-lightbox" data-title="Title"><i class="fa fa-search"></i></a>
                                                        <a href="#"><i class="fa fa-file"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="cbp-item corporate">
                                        <div class="cbp-caption">
                                            <div class="cbp-caption-hover-gradient">
                                                <img src="{{asset('assets/front/onepage2/img/portfolio/03.jpg')}}" alt="">
                                            </div>
                                            <div class="cbp-caption-activeWrap">
                                                <div class="cbp-l-caption-alignCenter">
                                                    <div class="cbp-l-caption-body portfolio-icons">
                                                        <a href="{{asset('assets/front/onepage2/img/portfolio/03.jpg')}}" class="cbp-lightbox" data-title="Title"><i class="fa fa-search"></i></a>
                                                        <a href="#"><i class="fa fa-file"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="cbp-item retail">
                                        <div class="cbp-caption">
                                            <div class="cbp-caption-hover-gradient">
                                                <img src="{{asset('assets/front/onepage2/img/portfolio/07.jpg')}}" alt="">
                                            </div>
                                            <div class="cbp-caption-activeWrap">
                                                <div class="cbp-l-caption-alignCenter">
                                                    <div class="cbp-l-caption-body portfolio-icons">
                                                        <a href="{{asset('assets/front/onepage2/img/portfolio/04.jpg')}}" class="cbp-lightbox" data-title="Title"><i class="fa fa-search"></i></a>
                                                        <a href="#"><i class="fa fa-file"></i></a>
                                                    </div>
                                                </div>
                                            </div>
...
<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]>
<script src="{{asset('assets/front/plugins/respond.min.js')}}"></script>
<script src="{{asset('assets/front/plugins/excanvas.min.js')}}"></script>
<![endif]-->
...
<script src="{{asset('assets/front/plugins/jquery.easing.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/front/plugins/jquery.parallax.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/front/plugins/smooth-scroll/smooth-scroll.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/front/plugins/owl.carousel/owl.carousel.min.js')}}" type="text/javascript"></script>
<!-- BEGIN CUBEPORTFOLIO -->
<script src="{{asset('assets/front/plugins/cubeportfolio/cubeportfolio/js/jquery.cubeportfolio.min.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/front/onepage2/scripts/portfolio.js')}}" type="text/javascript"></script>
<!-- END CUBEPORTFOLIO -->
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="{{asset('assets/front/onepage2/scripts/layout.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/front/pages/scripts/bs-carousel.js')}}" type="text/javascript"></script>
